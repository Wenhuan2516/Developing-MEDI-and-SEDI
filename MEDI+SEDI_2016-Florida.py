...
df_env_sd = df_env_sd[df_env_sd['State Code'] == '12']
df_env_sd.head()
...
df_env= df_env[df_env['State Code'] == '12']
df_env.head()
...
weight = {'elevation': 0.18, 'mean_temp': 0.06, 'station_pressure': 0.06, 'visibility': -0.21, 'wind_speed': 0.26, 'precipitation': -0.04, 'Relative_Humidity': 0.36, 
          'Heat_Index': 0.09, 'fog': -0.34, 'rain': -0.15, 'snow': 0.17, 'hail': 0.15, 'thunder': -0.11, 'tornado': -0.05, 'PM2.5': -0.09, 'Ozone': -0.12, 'Humidity_Temp_Index': 0.07}
...
fig = px.choropleth(df_env_sd, geojson=counties, locations='fips', color='SuicideDeathRate',
                           ...
                           range_color=(0, 35),
                           scope="usa",
                           labels={'SuicideDeathRate':'SuicideRate_Florida'}
                          )
fig.update_layout(margin={"r":0,"t":0,"l":0,"b":0})
fig.show()
...
fig = px.choropleth(df_env_sd, geojson=counties, locations='fips', color='elevation',
                           ...
                           range_color=(0, 100),
                           scope="usa",
                           labels={'elevation':'Elevation_Florida'}
                          )
fig.update_layout(margin={"r":0,"t":0,"l":0,"b":0})
fig.show()
...
fig = px.choropleth(df_env_sd, geojson=counties, locations='fips', color='mean_temp',
                           ...
                           range_color=(0, 85),
                           scope="usa",
                           labels={'mean_temp':'Mean_Temp_Florida'}
                          )
fig.update_layout(margin={"r":0,"t":0,"l":0,"b":0})
fig.show()
...
fig = px.choropleth(df_env_sd, geojson=counties, locations='fips', color='Relative_Humidity',
                           ...
                           range_color=(40, 80),
                           scope="usa",
                           labels={'Relative_Humidity':'Relative_Humidity_Florida'}
                          )
fig.update_layout(margin={"r":0,"t":0,"l":0,"b":0})
fig.show()
